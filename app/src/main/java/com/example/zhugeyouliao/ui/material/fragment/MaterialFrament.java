...
import com.example.zhugeyouliao.ui.competition.fragment.CompetitionTypeFragment;
 ...
 *
 * @Author： longyu
 * @Time： 2021/1/13 16:10
 * @description：诸葛秘料
 */
public class MaterialFrament extends LazyBaseFragments {
    ...
    public void initView() {
        ...
        mFragmentList.add(MaterialTypeFrament.newInstance(0));
        mFragmentList.add(MaterialTypeFrament.newInstance(1));
        mFragmentList.add(MaterialTypeFrament.newInstance(2));
