...
import com.example.zhugeyouliao.ui.home.fragment.TextLiveFragment;
...
public class FootballDetailsActivity extends BaseActivity {
    ...
    private TextLiveFragment mTextLiveFragment;
    ...
    protected void initData() {
        ...
        initTitle(getString(R.string.football_details));
        tvDetialsText.setVisibility(View.VISIBLE);
...
//        getTeamBattleData();
    ...
    /**
     * @date: 2021/1/28 7:34
     * @description 获取历史交锋数据
     */
    private void getTeamBattleData() {
        BaseOkHttpClient.newBuilder()
                .url(NetUrlUtils.GET_TEAM_BATTLE)
                .addParam("current", 1)
                .addParam("size", 10)
                .addParam("searchInt1", getFootBallContestData().getATeamId())
                .addParam("searchInt2", getFootBallContestData().getBTeamId())
                .post()
                .json()
                .form()
                .build()
    ...
    private void initFragment() {
        ...
        mMaterialFragment = BallMaterialFragment.newInstance(getFootBallContestData(), 1);
        mTextLiveFragment = TextLiveFragment.newInstance(getFootBallContestData());
        ...
        fragmentsList.add(mTextLiveFragment);
    ...
    private void initClcikBg() {
        ...
        tvDetialsText.setBackground(null);
    }

    @OnClick({R.id.tv_detials_material, R.id.tv_detials_text, R.id.tv_detials_matches, R.id.tv_detials_video, R.id.tv_issue})
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.tv_detials_material:
                ...
                break;
            case R.id.tv_detials_text:
                //文字直播
                nvpLayout.setCurrentItem(1);
                initClcikBg();
                tvDetialsText.setBackground(getResources().getDrawable(R.drawable.shape_white_10_top));
                break;
